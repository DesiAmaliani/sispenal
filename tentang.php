    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        ...
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="tentang.php">Tentang</a></li>
    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3 style="color: green;">SEJARAH AL HIDAYAH</h3>
        </header>

        <div class="row about-cols">
              <p align="center">
                Lembaga kursus Al Hidayah adalah sebuah lembaga pendidikan terpadu yang didirikan oleh Hj. Wasilah M.Pd yang sudah berdiri pada tahun 2011. 
                Lembaga kursus ini mengajarkan mata pelajaran seperti :
              </p>
              ...
              <p>
                  <ol type="1">
                    <?php
                         ...
                         $hasil = mysqli_query($con,"select * from mapel");
                         while ($baris = mysqli_fetch_array($hasil)){ ?>
                    <li>
                          <?php echo $baris[1]; echo "<br>";}?></li>
