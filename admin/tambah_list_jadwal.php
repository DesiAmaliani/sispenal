  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Tambah List jadwal</h3>
          </div>
        </div>
         <div class="row">
          <div class="col-lg-6">
            <section class="panel">
              <header class="panel-heading">
                Form Tambah List Jadwal
              </header>
              <form method="post" action="aksi_tambah_list_jadwal.php">
              <div class="panel-body">
                <form role="form">
                  ...
                  <div class="form-group">
                    ...
                    <input type="time" name="jam" value="<?=time('00:00')?>" required> -
                    <input type="time" name="sampai" value="<?=time('00:00')?>" required>
                  </div>
                  <div class="form-group">
