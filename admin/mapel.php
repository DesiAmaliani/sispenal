    ...
    <section id="container" class="">
      ...
      <section id="main-content">
        <section class="wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
              <h3 class="page-header"><i class="fa fa-laptop"></i> Mata Pelajaran</h3>
              <ol class="breadcrumb">
                <li><i class="fa fa-home"></i><a href="home.php">Home</a></li>
                <li><i class="fa fa-laptop"></i><a href="#">Tambahan</a></li>
                <li><i class="fa fa-table"></i><a href="mapel.php">Mata pelajaran</a></li>
              </ol>
            </div>
          </div>
          <div class="row">
                ...
                <table class="table table-striped table-advance table-hover">
                  <tbody>
                    <tr>
                      ...
                      <th><i class="icon_mobile"></i> Mata Pelajaran</th>
                      <th><i class="icon_profile"></i> Deskripsi</th>
                      <th><i class="icon_calendar"></i> Biaya</th>
                      <th><i class="icon_cogs"></i> Status</th>
                      <th><i class="icon_cogs"></i> Action</th>
                      <th><a class="btn btn-success" href="tambah_mapel.php"><i class="icon_plus_alt2"></i></a></th>
                    </tr>
                    <?php
                    $batas=5;
                    $hal=@$_GET['hal'];
                    ...
                    if ($_SERVER['REQUEST_METHOD']=="POST") {
                      ...
                      if ($pencarian !='') {
                        # code...
                        $sql_cari ="SELECT * from mapel where mapel like '%$pencarian%'";
                        $query = $sql_cari;
                        $query_jml=$sql_cari;
                        
                      }else{
                        $query="SELECT * from mapel limit $posisi,$batas";
                        $query_jml="SELECT * FROM mapel";
                        $no=$posisi+1;
                      }
                    }else{
                      $query="SELECT * from mapel limit $posisi,$batas";
                    ...
                    if (mysqli_num_rows($sql)>0) {
                      ...
                      while ($row = mysqli_fetch_array($sql)) {
                        ...
                        <td>
                        <div class=\"btn-group\">
                        <a class=\"btn btn-primary\" href=\"edit_mapel.php?ni=$row[id_mapel];\"><i class=\"icon_document_alt\"></i></a>
                        <a class=\"btn btn-danger\" href=\"delete_mapel.php?ni=$row[id_mapel];\" onclick=\"return confirm('yakin mau di hapus ?');\"><i class=\"icon_close_alt2\"></i></a>
                        </td>";
                      }
                    }else{
