    ...
    <section id="container" class="">
      ...
      <section id="main-content">
        <section class="wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
              <h3 class="page-header"><i class="fa fa-laptop"></i> Pengajar</h3>
              <ol class="breadcrumb">
                <li><i class="fa fa-home"></i><a href="home.php">Home</a></li>
                <li><i class="fa fa-table"></i><a href="mapel.php">Pengajar</a></li>
              </ol>
            </div>
          </div>
          <div class="row">
                ...
                <table class="table table-striped table-advance table-hover">
                  <tbody>
                    <tr>
                      ...
                      <th><i class="icon_pin_alt"></i> No HP</th>
                      <th><i class="icon_mobile"></i> Alamat</th>
                      <th><i class="icon_mobile"></i> Riwayat Pendidikan</th>
                      <th><i class="icon_cogs"></i> Action</th>
                      <th><a class="btn btn-success" href="tambah_guru.php"><i class="icon_plus_alt2"></i></a></th>
                    </tr>
                    <?php
                    $batas=5;
                    $hal=@$_GET['hal'];
                    ...
                    if ($_SERVER['REQUEST_METHOD']=="POST") {
                      ...
                      if ($pencarian !='') {
                        # code...
                        $sql_cari ="SELECT * from guru where nama_guru like '%$pencarian%'";
                        $query = $sql_cari;
                        $query_jml=$sql_cari;
                        
                      }else{
                        $query="SELECT * from guru limit $posisi,$batas";
                        $query_jml="SELECT * FROM guru";
                        $no=$posisi+1;
                      }
                    }else{
                      $query="SELECT * from guru limit $posisi,$batas";
                    ...
                    if (mysqli_num_rows($sql)>0) {
                      ...
                      while ($row = mysqli_fetch_array($sql)) {
                        ...
                        <td>$row[no_hp]</td>
                        <td>$row[alamat]</td>
                        <td>$row[riwayat_pen]</td>
                        <td>
                        <div class=\"btn-group\">
                        <a class=\"btn btn-primary\" href=\"edit_guru.php?ni=$row[kd_guru];\"><i class=\"icon_document_alt\"></i></a>
                        <a class=\"btn btn-danger\" href=\"hapus_guru.php?ni=$row[kd_guru];\" onclick=\"return confirm('yakin mau di hapus ?');\"><i class=\"icon_close_alt2\"></i></a>
                        </td>";
                      }
                    }
                    ?>
