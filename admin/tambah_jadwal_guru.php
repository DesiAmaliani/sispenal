  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Tambah Jadwal Guru</h3>
          </div>
        </div>
         <div class="row">
          <div class="col-lg-6">
            <section class="panel">
              ...
              <form method="post" action="aksi_tambah_jadwal_guru.php">
              <div class="panel-body">
                <form role="form">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Jadwal Tempat" name="jadwal_tempat">
                  </div>
                  <div class="form-group">
