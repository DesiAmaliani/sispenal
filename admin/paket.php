    ...
    <section id="container" class="">
      ...
      <section id="main-content">
        <section class="wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
              <h3 class="page-header"><i class="fa fa-laptop"></i> Paket Mata Pelajaran</h3>
              <ol class="breadcrumb">
                <li><i class="fa fa-home"></i><a href="home.php">Home</a></li>
                <li><i class="fa fa-laptop"></i><a href="#">Tambahan</a></li>
                <li><i class="fa fa-table"></i><a href="paket.php">Paket Mata pelajaran</a></li>
              </ol>
            </div>
          </div>
          <div class="row">
              ...
              <section class="panel">
                ...
                <table class="table table-striped table-advance table-hover">
                  <tbody>
                    <tr>
                      <th>No</th>
                      <th> ID Paket Mata Pelajaran</th>
                      <th><i class="icon_mobile"></i> Tingkat</th>
                      <th><i class="icon_profile"></i> Mata Pelajaran</th>
                      <th><i class="icon_cogs"></i> Action</th>
                      <th><a class="btn btn-success" href="tambah_paket.php"><i class="icon_plus_alt2"></i></a></th>
                    </tr>
                    <?php
                    error_reporting(0);
                    ...
                    while ($row = mysqli_fetch_array($sql)) {
                      ...
                      <td>$row[tingkat]</td>
                      <td>";
                      $sql_mapel = mysqli_query($con,"SELECT * FROM paket_mapel JOIN mapel ON paket_mapel.id_mapel=mapel.id_mapel where id_paket='$row[id_paket]'");
                      while ($row_mapel = mysqli_fetch_array($sql_mapel)) {
                        echo $row_mapel['mapel']."<br>";
                      }
                      echo "
                      </td>
                        <td>
                        <div class=\"btn-group\">
                        <a class=\"btn btn-primary\" href=\"edit_paket.php?ni=$row[id_paket];\"><i class=\"icon_document_alt\"></i></a>
                        <a class=\"btn btn-danger\" href=\"hapus_paket.php?ni=$row[id_paket];\"><i class=\"icon_close_alt2\"></i></a>
                        </td>";
                        $a++;
