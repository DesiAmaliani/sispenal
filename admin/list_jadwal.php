    ...
    <section id="container" class="">
      ...
      <section id="main-content">
        <section class="wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
              <h3 class="page-header"><i class="fa fa-laptop"></i> List Jadwal</h3>
              <ol class="breadcrumb">
                <li><i class="fa fa-home"></i><a href="home.php">Home</a></li>
                <li><i class="fa fa-laptop"></i><a href="#">Tambahan</a></li>
                <li><i class="fa fa-table"></i><a href="list_jadwal.php">List Jadwal</a></li>
              </ol>
            </div>
          </div>
          <div class="row">
              ...
              <section class="panel">
                ...
                <table class="table table-striped table-advance table-hover">
                  <tbody>
                    <tr>
                      <th>No</th>
                      <th> ID List Jadwal</th>
                      <th><i class="icon_mobile"></i> Hari</th>
                      <th><i class="icon_profile"></i> Jam</th>
                      <th><i class="icon_profile"></i> Paket</th>
                      <th><i class="icon_profile"></i> Jenis Kelas</th>
                      <th><i class="icon_cogs"></i> Action</th>
                      <th><a class="btn btn-success" href="tambah_list_jadwal.php"><i class="icon_plus_alt2"></i></a></th>
                    </tr>
                    <?php
                    error_reporting(0);
                    $sql = mysqli_query($con,"SELECT * FROM list_jadwal INNER JOIN paket ON list_jadwal.paket=paket.id_paket");
                    $a=1;
                    while ($row = mysqli_fetch_array($sql)) {
                      ...
                      <td>$a</td>
                      <td>$row[id_jadwal]</td>
                      <td>$row[hari] $row[hari2]</td>
                      <td>$row[jam]-$row[sampai]</td>
                      <td>$row[tingkat]</td>
                      <td>$row[jenis_kelas]</td>
                        <td>
                        <div class=\"btn-group\">
                        <a class=\"btn btn-primary\" href=\"edit_list_jadwal.php?ni=$row[id_jadwal];\"><i class=\"icon_document_alt\"></i></a>
                        <a class=\"btn btn-danger\" href=\"hapus_list_jadwal.php?ni=$row[id_jadwal];\"><i class=\"icon_close_alt2\"></i></a>
                        </td>";
                        $a++;
