    ...
    <section id="container" class="">
      ...
      <section id="main-content">
        <section class="wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
              <h3 class="page-header"><i class="fa fa-laptop"></i> Tambah List harga</h3>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-6">
              <section class="panel">
                <header class="panel-heading">
                  Form Tambah List harga
                </header>
                <form method="post" action="aksi_tambah_list_harga.php">
                  <div class="panel-body">
                    <form role="form">
                      ...
                      <div class="form-group">
                        <label class="exampleInputEmail1">Harga</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Harga" name="harga">
                      </div>
                      <div class="form-group">
