    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3 style="color: purple;">Registrasi</h3>
        </header>
        <div class="row">
          <div class="col-lg-12 wow fadeInUp">
            <section class="panel">
              ...
              <div class="panel-body">
                <form class="form-horizontal " method="post" action="tambah_registrasi.php" enctype="multipart/form-data">
                  <div class="form-group">
                    <label class="col-lg-2 control-label">Nama Peserta</label>
                    <div class="col-lg-10">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <input type="Date" class="form-control" name="tgl_pem" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-lg-2 control-label">No Rekening</label>
                    <div class="col-lg-10">
                      <input class="form-control" id="focusedInput" type="text" name="no_rek" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-lg-2 control-label">Total Pembayaran</label>
                    <div class="col-lg-10">
                      <input type="text" class="form-control" name="total_pem" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-lg-2 control-label">Jenis Kelas</label>
                     <div class="col-lg-10">
