          ...
          <div>
            <ul class="nav-menu">
              ...
              <ul class="nav-menu">
                ...
                <li class="menu-active"><a href="list_pengajar.php">List Pengajar</a></li>
              </ul></div>
      ...
      <section id="about">
        <div class="container">
          ...
          <header class="section-header">
            <h3 style="color: brown;">List Pengajar</h3>
          </header>
            ...
            <div class="container">
              ...
              <div class="owl-carousel testimonials-carousel">
                <?php
                         ...
                         $hasil = mysqli_query($con,"select * from guru");
                         while ($baris = mysqli_fetch_array($hasil)){ ?>
                <div class="testimonial-item">
                  <?php echo "<img src='admin/galeri/".$baris['foto']."'class=\"testimonial-img\" alt=\"\">"?>
                  <h3><?php echo $baris['nama_guru'];?></h3>
                  <p>
                    <img src="img/quote-sign-left.png" class="quote-sign-left" alt="">
                    <?php echo $baris['riwayat_pen']; ?>
