  ...
  <header id="header" style="background-color: black; height: 110px">
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        ...
        <ul class="nav-menu">
          <li class="menu-active"><a href="list_harga.php">List Harga</a></li>
    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3 style="color: teal;">LIST HARGA</h3>
        </header>
                ...
                <ol start="A" type="A">
                  ...
                  <ul>
                     <?php
                         ...
                         $hasil = mysqli_query($con,"SELECT * from list_harga inner join paket on list_harga.paket=paket.id_paket where jenis_kelas='Regular'");
                         while ($baris = mysqli_fetch_array($hasil)){ ?>
                    <li><?php echo $baris['tingkat'];?></li>
                    <p>Rp. <?php echo $baris['harga'];?> / Bulan (8x Pertemuan)<?php echo "<br>";}?></p>
                  </ul>
                  <li>Kelas Privat</li>
                  <ul>
                    <?php
                         $hasil = mysqli_query($con,"SELECT * from list_harga inner join paket on list_harga.paket=paket.id_paket where jenis_kelas='Privat'");
                         while ($baris = mysqli_fetch_array($hasil)){ ?>
                    <li><?php echo $baris['tingkat'];?></li>
                    <p>Rp. <?php echo $baris['harga'];?> / Bulan (8x Pertemuan)<?php echo "<br>";}?></p>
                  </ul>
